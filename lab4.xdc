...
set_property -dict { PACKAGE_PIN R13 IOSTANDARD LVCMOS33 }   [ get_ports { din[3] }    ] ;
set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33 }   [ get_ports { din[2] }    ] ;
set_property -dict { PACKAGE_PIN T18 IOSTANDARD LVCMOS33 }   [ get_ports { din[1] }  ] ;
set_property -dict { PACKAGE_PIN R17 IOSTANDARD LVCMOS33 }   [ get_ports { din[0] }    ] ;

set_property -dict { PACKAGE_PIN R15 IOSTANDARD LVCMOS33 }   [ get_ports { sel[1] }    ] ;
